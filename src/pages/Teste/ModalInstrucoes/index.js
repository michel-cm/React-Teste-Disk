...
export const ModalInstrucoes = ({ setModalInstrucoes }) => {
  const { user } = useAuth();

  return (
    <C.ContainerInstrucoes>
      <C.AreaIconClose onClick={() => setModalInstrucoes(false)}>
        <C.Icon>
          <BsXLg
            style={{
              fontSize: "24px",
      ...
      <C.AreaInstrucoes>
        ...
        <C.AreaLembrete>
          <p>
            É muito <b>importante</b> que enumere cada uma das opções com 1,2,3
            e 4
          </p>
          <p>
            <b>NÃO PENSE MUITO PARA RESPONDER</b>, o primeiro pensamento que vem
            à mente é o mais instintivo, livre de filtros ou direcionamentos.
          </p>
          <p>
            Lembre-se que <b>não podem ocorrer empates</b>. Um mesmo número não
            pode ser usado duas vezes na mesma questão.
          </p>
          <C.AreaTempo>
